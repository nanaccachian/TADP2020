...
class astSpec extends AnyFlatSpec with should.Matchers  {
  "blank" should "parsea 1 espacios" in {
    ast.blankParser(" a") shouldEqual ParserResultSuccess(List(' '), "a")
  }
  ...
  "point" should "parsea correctamente '25.2 @  -3425a'" in {
    ast.pointParser("25.2 @  -3425a") shouldEqual ParserResultSuccess(Point(25.2, -3425), "a")
  }

  it should "no parsea '25.2 ,  -3425'" in {
    an[ParserError] should be thrownBy ast.pointParser("25.2 ,  -3425").getConsumed
  }
}
